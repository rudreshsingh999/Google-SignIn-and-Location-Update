...
public class AccountActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /////////////////////////
        mAuth = FirebaseAuth.getInstance();
        mLogOutBtn = (Button) findViewById(R.id.signout);
...
//        Toast.makeText(this, "Bundle", Toast.LENGTH_SHORT).show();
    ...
    private void startLocationUpdates() {
        Toast.makeText(this, "starteeeLocationUpdates", Toast.LENGTH_SHORT).show();
        mSettingsClient
                        ...
                        switch (statusCode) {
                            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                Log.i(TAG, "Location settings are not satisfied. Attempting to upgrade " +
                                        "location settings ");
                                Toast.makeText(AccountActivity.this, "OOPS!", Toast.LENGTH_LONG).show();
                                try {
...
//                            openSettings();
                            startLocationUpdates();
                            Toast.makeText(AccountActivity.this, "OOPS!", Toast.LENGTH_SHORT).show();
                        }
                    }
    ...
    private boolean checkPermissions() {
        ...
        Toast.makeText(this, permissionState , Toast.LENGTH_SHORT).show();
